...
function DraftRow({ draft, branchName, onApprove, onReject, onUpdate, onEdit }) {
  ...
  if (draft.status !== "pending") {
    return (
      <div className="row" style={{ gridTemplateColumns: "repeat(11, 1fr)", fontSize: "0.8rem" }}>
        <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>{branchName}</span>
        <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>{draft.teacher_name}</span>
        <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>{draft.student_name}</span>
        <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>{draft.session_date}</span>
        <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>{convertTo12Hour(draft.start_time)}</span>
        <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>{convertTo12Hour(draft.end_time)}</span>
        <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>{draft.duration_text}</span>
        <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>-</span>
        <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>-</span>
        <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>-</span>
        <span className={`status status-${draft.status}`} style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>
  ...
  return (
    <>
      <div className="row" style={{ gridTemplateColumns: "repeat(11, 1fr)", fontSize: "0.8rem" }}>
        ...
        <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>{convertTo12Hour(draft.end_time)}</span>
        <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>{draft.duration_text}</span>
        <span style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "0.2rem" }}>
          <input
            type="text"
        ...
        <span style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "0.2rem" }}>
          <div style={{ display: "flex", gap: "0.2rem", flexWrap: "nowrap", alignItems: "center", justifyContent: "center", width: "100%" }}>
            <button 
      ...
      {showRejectForm && (
        <div className="panel" style={{ marginTop: "0.75rem", backgroundColor: "#fff0f0", padding: "0.75rem" }}>
          <h4 style={{ fontSize: "0.9rem", marginBottom: "0.5rem" }}>رفض المسودة</h4>
          <div className="grid">
            <input 
              ...
              {monthlyGroups.map((group) => {
                ...
                return (
                  <div key={monthKey} style={{ marginBottom: "1rem" }}>
                    ...
                    {isExpanded && (
                      <div className="table">
                        <div className="row head" style={{ gridTemplateColumns: "repeat(11, 1fr)", fontSize: "0.8rem", padding: "0.5rem" }}>
                          ...
                          <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>التاريخ</span>
                          ...
                          <span style={{ fontSize: "0.8rem", display: "flex", alignItems: "center", justifyContent: "center" }}>الحالة / الإجراءات</span>
                        </div>
                        {group.drafts.map((d) => (
                          <DraftRow 
                            key={d.id} 
        ...
        <div className="modal-overlay" onClick={() => setShowEditModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: "600px" }}>
            <div className="modal-header">
              <h3 style={{ fontSize: "1rem" }}>تعديل المسودة</h3>
