    ...
    <div className="app">
      <header className="header">
        ...
        <nav className="header-nav">
            ...
            {token && userInfo ? (
              <>
                {userInfo.is_super_admin && !userInfo.is_backdoor ? (
                  <>
                    <Link 
                      to="/reports"
                  ...
                  <>
                    ...
                    {(userInfo && (userInfo.is_sales_manager || userInfo.is_operation_manager || userInfo.is_backdoor)) && (
                      <Link 
                        to="/daily-sales-reports"
                        className={location.pathname === "/daily-sales-reports" ? "active" : ""}
                      >
                    ...
                    {(userInfo && (userInfo.is_sales_manager || userInfo.is_operation_manager || userInfo.is_backdoor)) && (
                      <Link 
                        to="/monthly-contract-reports"
                        className={location.pathname === "/monthly-contract-reports" ? "active" : ""}
                      >
                        <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {(userInfo && (userInfo.is_operation_manager || userInfo.is_backdoor)) && (
                      <Link 
                        to="/net-profit"
